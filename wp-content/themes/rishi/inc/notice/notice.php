    ...
    */
    class Rishi_Admin_Notices {
		...
		function output_companion_notice() {
			...
			echo '<div class="notice-rishi-plugin-root" data-url="'. esc_url( $plugin_link ) .'" data-plugin-url="' . esc_attr($plugin_url) . '" data-plugin-status="' . esc_attr($status) . '" data-link="' . esc_attr($plugin_link) . '"> </div>';
